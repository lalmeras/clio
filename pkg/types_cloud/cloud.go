...
type CmdParameters struct {
	...
	GET_access_string string
	GET_accountId_string string
	GET_aclId_uuid string
	GET_addonFamily_string string
	GET_advanced_boolean bool
	GET_alertId_long int64
	GET_appId_uuid string
	GET_backupId_uuid string
	...
	GET_databaseId_uuid string
	GET_extended_boolean bool
	GET_flavorId_string string
	GET_flavorId_uuid string
	GET_flavorType_string string
	GET_floatingIpId_uuid string
	GET_from_datetime string
	GET_from_string string
	GET_groupId_string string
	GET_healthMonitorId_uuid string
	GET_id_long int64
	GET_id_string string
	GET_id_uuid string
	GET_imageId_string string
	GET_indexId_uuid string
	GET_instanceId_string string
	GET_integrationId_uuid string
	GET_interfaceId_string string
	GET_interfaceId_uuid string
	GET_ipBlock_ipBlock string
	GET_jobId_uuid string
	GET_keyId_string string
	GET_kubeId_string string
	GET_l7PolicyId_uuid string
	GET_l7RuleId_uuid string
	GET_labId_string string
	GET_limit_long int64
	GET_listenerId_uuid string
	GET_loadBalancerId_uuid string
	GET_loadbalancerId_uuid string
	GET_maintenanceId_uuid string
	GET_marker_string string
	GET_memberId_uuid string
	GET_metricName_string string
	GET_migrationId_string string
	GET_modelId_string string
	GET_name_string string
	GET_namespaceId_string string
	GET_namespaceId_uuid string
	GET_networkId_string string
	GET_noObjects_boolean bool
	GET_nodeId_string string
	GET_nodeId_uuid string
	GET_nodePoolId_string string
	GET_notebookId_string string
	GET_offset_long int64
	GET_operationId_string string
	GET_page_long int64
	GET_patternId_uuid string
	GET_planCode_string string
	GET_planFamily_string string
	GET_poolId_uuid string
	GET_presetId_string string
	GET_product_string string
	GET_regionName_string string
	GET_region_string string
	GET_registryID_string string
	GET_registryId_string string
	GET_replica_string string
	GET_replicationId_uuid string
	GET_roleId_string string
	GET_secretId_uuid string
	GET_serviceName_string string
	GET_size_long int64
	GET_snapshotId_string string
	GET_sort_string string
	GET_stackId_string string
	GET_streamId_uuid string
	GET_subnetId_string string
	GET_subscriptionId_uuid string
	GET_taskId_long int64
	GET_toDate_datetime string
	GET_to_datetime string
	GET_tokenId_uuid string
	GET_topicId_uuid string
	GET_type_string string
	GET_updatedAfter_datetime string
	GET_usageId_string string
	GET_userId_long int64
	GET_userId_uuid string
	GET_userName_string string
	GET_version_long int64
	GET_volumeId_string string
	GET_voucher_password string
}